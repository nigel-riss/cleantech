    ...
    <div class="hero-n-services">
        <section class="hero">
            <div class="hero__wrapper">
                <p class="hero__welcome">Welcome</p>
                ...
                <a class="button" href="<?php echo esc_url(home_url('/')); ?>about">About us</a>
            </div>
        </section>
        ...
        <section class="services">
            <div class="services__main">
                ...
                <a class="button button--mt-40" href="<?php echo esc_url(home_url('/')); ?>services">All services</a>
            </div>

            <div class="services__dir">
                <p class="services__subtitle">Activities</p>
            ...
            <div class="services__projects">
                <p class="services__subtitle">Our projects</p>
                <p class="services__text">List of current and realized projects</p>
                <a class="button button--sand" href="<?php echo esc_url(home_url('/')); ?>projects">Our projects</a>
            </div>
        </section>
    </div>
