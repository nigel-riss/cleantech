...
// $loc = new IP2Location('./IP2LOCATION-LITE-DB1.BIN', IP2Location::FILE_IO);
// $record = $loc->lookup($_SERVER['REMOTE_ADDR'], IP2Location::ALL);



if($records['countryCode'] == 'RU') {
    $urlToRedir = "http://ru.baltcleantech.com";
} else {
    $urlToRedir = "http://en.baltcleantech.com";
}
...
<script>
    // window.location.replace('<?php echo $urlToRedir; ?>');
</script>